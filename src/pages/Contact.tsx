...
export default function Contact() {
  ...
  <div className="bg-gradient-to-br from-black to-gray-900 py-24 bg-squares">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 data-aos="fade-up" className="text-5xl md:text-6xl font-bold text-gray-100 mb-6">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-12">
        <div className="grid md:grid-cols-2 gap-8">
          <div data-aos="fade-up" data-aos-duration="3500" className="bg-gray-800 rounded-xl shadow-xl p-8">
            <h2 data-aos="fade-up" className="text-3xl font-bold text-gray-100 mb-8">Envoyez-nous un message</h2>

            {submitted && (
              <div className="bg-green-900 border border-green-700 text-green-100 px-4 py-3 rounded-lg mb-6 animate-fade-in">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="nom" className="block text-gray-200 font-medium mb-2">
                  Nom complet *
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="email" className="block text-gray-200 font-medium mb-2">
                  ...
                  required
                  className="w-full px-4 py-3 bg-[#2b2b2b] placeholder-gray-400 border border-gray-600 rounded-lg focus:border-[#FFD700] transition-colors duration-200"
                  placeholder="Doc'trot@gmail.com"
                />
              </div>

              <div>
                <label htmlFor="telephone" className="block text-gray-200 font-medium mb-2">
                  Téléphone
                </label>
                <input
                  type="tel"
          ...
          <div className="space-y-8">
            <div data-aos="fade-up" data-aos-duration="3500" className="bg-gray-800 rounded-xl shadow-xl p-8">
              <h2 className="text-3xl font-bold text-gray-100 mb-6">Nos Coordonnées</h2>
